# -*- coding: utf-8 -*-
#
# Caelus Python documentation build configuration file, created by
# sphinx-quickstart on Sat Sep 16 10:28:39 2017.
#
...
project = u'Caelus Python Library (CPL)'
copyright = u'2017, Applied CCM'
author = u'Applied CCM'
...
#html_title = u'Caelus Python v0.1.1'
...
latex_documents = [
    (master_doc, 'CPL.tex', u'Caelus Python Library (CPL)',
...
def setup(app):
    ...
    app.add_object_type("taskopt", "taskopt",
                        objname="CPL task option",
                        indextemplate="pair: %s; CPL task option")
